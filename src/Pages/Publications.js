  ...
  return (
    <div className='publications'>
        ...
        <div className="publications__content">
          <Work title='
          High step-up quasi-resonant converter featuring minimized switching loss over wide input voltage range [IEEE Transaction on Industrial Electronics]'
          ...
          />
             <Work title='Highly efficient current-fed half-bridge resonant converter for pulse power applications [IEEE Transaction on Power Electronics]'
          ...
          />
          <Work title='
Bidirectional soft switching push–pull resonant converter over wide range of battery voltages [IEEE Transaction on Power Electronics]'
          ...
          />
           <Work title='Highly efficient quasi-single-stage AC-DC converter employing bidirectional switch [IEEE Transactions on Transportation Electrification]'
          ...
          />
          <Work title='A Comparative Study of Three-Phase Inverter Topologies for Common Mode Voltage Reduction in Photovoltaic Applications [2023 25th European Conference on Power Electronics and Applications]'
...
<Work title='An Overview of the Functions of Smart Grids Associated with Virtual Power Plants Including Cybersecurity Measures [Doctoral Conference on Computing, Electrical and Industrial Systems]'
          ...
          <Work title='An Improved Three-Phase Transformerless Neutral Point Clamped Inverter Topology for Common Mode Voltage Reduction [2023 IEEE 17th International Conference on Compatibility, Power Electronics and Power Engineering]'
          ...
          />
          <Work title='Performance Evaluation of a Three-Phase PV Power Plant under Unbalanced Conditions with Islanding Detection Reliability Test [2023 IEEE 17th International Conference on Compatibility, Power Electronics and Power Engineering]'
